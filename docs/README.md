...
| 3 | [03-alb-addons-monitoring.md](03-alb-addons-monitoring.md) | LB Controller (Pod Identity), Metrics Server, Prometheus/Grafana, ALB Ingress, Route 53, ACM, CloudFront |
